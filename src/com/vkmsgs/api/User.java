...
public class User {
    ...
    public static User parse(JSONObject o) throws JSONException {
        ...
        if(!o.isNull("nickname"))
            u.nickname = VKApi.unescape(o.optString("nickname"));
        if(!o.isNull("domain"))
        ...
        if(!o.isNull("activity"))
            u.status = VKApi.unescape(o.optString("activity"));
    ...
    public static User parseFromNews(JSONObject jprofile) throws JSONException {
        ...
        m.first_name = VKApi.unescape(jprofile.getString("first_name"));
        m.last_name = VKApi.unescape(jprofile.getString("last_name"));
